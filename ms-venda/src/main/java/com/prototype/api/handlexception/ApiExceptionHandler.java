...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleErroComunicacao(ErroComunicacaoException ex, WebRequest request) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        ProblemTypeBean problemType = new ProblemTypeBean(ProblemType.ERRO_DE_SISTEMA, url);
